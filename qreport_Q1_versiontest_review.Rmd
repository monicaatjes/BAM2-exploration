...
```{r overview Desirability, echo=F, eval=T, fig.align='left', fig.width=5.5, fig.height=4}
desi <- test %>%
...
There are some important changes that impacted the absolute scores of desirability.  

  * Respondents clicked on brands in the previous version, where they are asked to rank the banks on a scale (0-100) in the new version.
  * The increased absolute scores count for the other banks as well. 
...
<div class="row">
  <div class="col-md-7" markdown="1">
```{r overview Reputation, eval=T, echo=F, fig.align='left', fig.height=4, fig.width=5.5}
rep <- test %>%
...
<div class="row">
  <div class="col-md-7" markdown="1">
```{r overview internal NPS, echo=F, eval=T, fig.align='left', fig.width=5.5, fig.height=4}
### INTERNAL NPS 
...
* Q1 2020 contains scores from the Brand & Communication monitor. Countries with a small base size >50 are not reported. The scores for Q1 2020 are not averaged with previous quarters. 
  </div>
</div>
...
``` 
  ...
  * ING is as desired as Easy bank. 
...
```
  ...
  * The new banks (N26 and Revolut) clearly outperform regarding CX principles. 
