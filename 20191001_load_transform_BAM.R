...
data <- full_join(data, tempREP110, by=c("b_value", "country", "quarter_measurement"))
rm(tempREP110)
...
data <- full_join(data, tempREP22, by=c("b_value", "country", "quarter_measurement"))
rm(tempREP22)
...
data <- full_join(data, tempREP23, by=c("b_value", "country", "quarter_measurement"))
rm(tempREP23)
...
data <- full_join(data, tempREP24, by=c("b_value", "country", "quarter_measurement"))
rm(tempREP24)
...
labels_quarters <-data %>%
  ...
  dplyr::mutate(
    labels_quarters = case_when(
      quarter_measurement == 0 ~ "2014 Q4",
      quarter_measurement == 1 ~ "2015 Q1",
      quarter_measurement == 2 ~ "2015 Q2",
      quarter_measurement == 3 ~ "2015 Q3",
      quarter_measurement == 4 ~ "2015 Q4",
      quarter_measurement == 5 ~ "2016 Q1",
      quarter_measurement == 6 ~ "2016 Q2",
      quarter_measurement == 7 ~ "2016 Q3",
      quarter_measurement == 8 ~ "2016 Q4",
      quarter_measurement == 9 ~ "2017 Q1",
      quarter_measurement == 10 ~ "2017 Q2",
      quarter_measurement == 11 ~ "2017 Q3",
      quarter_measurement == 12 ~ "2017 Q4",
      quarter_measurement == 13 ~ "2018 Q1",
      quarter_measurement == 14 ~ "2018 Q2",
      quarter_measurement == 15 ~ "2018 Q3",
      quarter_measurement == 16 ~ "2018 Q4",
      quarter_measurement == 17 ~ "2019 Q1",
      quarter_measurement == 18 ~ "2019 Q2",
      quarter_measurement == 19 ~ "2019 Q3",
      quarter_measurement == 20 ~ "2019 Q4",
      TRUE ~ "NA_real_"))
