...
internal <- internal %>%
  dplyr::select(labels_countries, `2018 Q2`, `2018 Q3`, `2018 Q4`, `2019 Q1`, `2019 Q2`, `2019 Q3`, `2019 Q4`) %>%
...
internal1 <- internal %>%
  ...
  dplyr::filter(!is.na(`2019 Q4` & `2019 Q3` & `2019 Q2`)) %>%
  dplyr::mutate(
    # Calculate CAGR
...
```{r tab, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
```{r tabAUT, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==2) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y = ~desi_time$ING, type='scatter', name='ING',
            line = list(color = 'rgb(255,098,000)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`BAWAG P S K  Bank` , type='scatter', name='BAWAG PSK Bank',
            line = list(color = 'rgb(96,166,218)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$Easybank, type='scatter', name='Easybank',
            line = list(color = 'rgb(171,0,102)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Erste Bank und Sparkasse`, type='scatter', name='Erste Bank und Sparkasse',
            line = list(color = 'rgb(208,217,60)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Raiffeisen Sektor`, type='scatter', name='Raiffeisen Sektor',
            line = list(color = 'rgb(52,150,81)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  layout(title = "",
         xaxis = xaxis,
         yaxis = yaxis,
...
rep_b<-rep_brand %>%
  ...
  add_lines(y =~rep_brand$'2', type='scatter', name='Raiffeisen',
            line = list(color = 'rgb(96,166,218)', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'3', type='scatter', name='Erste Bank und Sparkasse',
            line = list(color = 'rgb(171,0,102)', width = 4, mode = 'lines+markers')) %>%
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==2) %>%
  dplyr::arrange(country)
...
```{r tabBEL, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==3) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y =~desi_time$`Belfius Banque` , type='scatter', name='Belfius Banque',
            line = list(color = 'rgb(96,166,218)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`BNP Paribas Fortis`, type='scatter', name='BNP Paribas',
            line = list(color = 'rgb(171,0,102)', type='scatter', width = 4, mode = 'lines+markers')) %>%
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==3) %>%
  dplyr::arrange(country)
...
```{r tabCZ, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==4) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y = ~desi_time$ING, type='scatter', name='ING',
            line = list(color = 'rgb(255,098,000)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Cesk  spoitelna` , type='scatter', name='Cesk  spoitelna',
            line = list(color = 'rgb(96,166,218)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$SOB, type='scatter', name='SOB',
            line = list(color = 'rgb(171,0,102)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Komern  banka`, type='scatter', name='Komern  banka',
            line = list(color = 'rgb(208,217,60)', type='scatter', width = 4, mode = 'lines+markers')) %>%
...
```{r tabFR, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==5) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==5) %>%
  dplyr::arrange(country)
...
```{r tabGE, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==6) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==6) %>%
  dplyr::arrange(country)
...
```{r tabIT, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==7) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y =~desi_time$`Intesa Sanpaolo`, type='scatter', name='Intesa Sanpaolo',
            line = list(color = 'rgb(208,217,60)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Monte dei Paschi di Siena`, type='scatter', name='Monte dei Paschi di Siena',
            line = list(color = 'rgb(52,150,81)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  layout(title = "",
         xaxis = xaxis,
         yaxis = yaxis,
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==7) %>%
  dplyr::arrange(country)
...
```{r tabLUX, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==8) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y = ~desi_time$ING, type='scatter', name='ING',
            line = list(color = 'rgb(255,098,000)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Banque et Caisse d Epargne de l Etat` , type='scatter', name='`Banque et Caisse d Epargne de l Etat`',
            line = list(color = 'rgb(96,166,218)', type='scatter', width = 4, mode = 'lines+markers')) %>%
...
rep_b<-rep_brand %>%
  ...
  add_lines(y = ~rep_brand$'1', type='scatter', name='ING',
            line = list(color = 'rgb(255,098,000)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'2', type='scatter', name='Banque et Caisse d’Epargne de l’Etat',
            line = list(color = 'rgb(96,166,218)', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'3', type='scatter', name='BGL BNP Paribas',
            line = list(color = 'rgb(171,0,102)', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'4', type='scatter', name='Banque International a Luxembourg',
            line = list(color = 'rgb(208,217,60)', width = 4, mode = 'lines+markers')) %>%
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==8) %>%
  dplyr::arrange(country)
...
```{r tabNL, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==9) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==9) %>%
  dplyr::arrange(country)
...
```{r tabPOL, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==10) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
rep_b<-rep_brand %>%
  ...
  add_lines(y =~rep_brand$'3', type='scatter', name='mBank',
            line = list(color = 'rgb(171,0,102)', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'4', type='scatter', name='Pekao S.A',
            line = list(color = 'rgb(208,217,60)', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~rep_brand$'5', type='scatter', name='PKO BP',
          line = list(color = 'rgb(52,150,81)', width = 4, mode = 'lines+markers')) %>%
  layout(title = "",
         xaxis = xaxis,
         yaxis = yaxis, legend =list(font = list(family = "ING me", size = 12, color = 'rgb(105, 105, 105)')))
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==10) %>%
  dplyr::arrange(country)
...
```{r tabROM, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==11) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y =~desi_time$BRD, type='scatter', name='BRD',
            line = list(color = 'rgb(171,0,102)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Raiffeisen Bank`, type='scatter', name='Raiffeisen Bank',
            line = list(color = 'rgb(208,217,60)', type='scatter', width = 4, mode = 'lines+markers')) %>%
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==11) %>%
  dplyr::arrange(country)
...
```{r tabSP, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==12) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==12) %>%
  dplyr::arrange(country)
...
```{r TURtab, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==13) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
...
desi_timep1 <-desi_time %>%
  ...
  add_lines(y =~desi_time$Akbank, type='scatter', name='Akbank',
            line = list(color = 'rgb(96,166,218)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Garanti Bankas`, type='scatter', name='Garanti Bankasi',
            line = list(color = 'rgb(171,0,102)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$ISBankas, type='scatter', name='IsBankasi',
            line = list(color = 'rgb(208,217,60)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  add_lines(y =~desi_time$`Yap  Kredi Bankas`, type='scatter', name='Yap  Kredi Bankasi',
            line = list(color = 'rgb(52,150,81)', type='scatter', width = 4, mode = 'lines+markers')) %>%
  layout(title = "",
         xaxis = xaxis,
         yaxis = yaxis,
...
customerthing <- test_customer_fig %>%
  dplyr::select(labels_quarters, country, b_value, "Active customers", "Primary bank customers", 
                "Avg number of product categories per active customer") %>%
  dplyr::filter(b_value ==1 & labels_quarters %in% c("2018 Q3", "2018 Q4", "2019 Q1", "2019 Q2", "2019 Q3", "2019 Q4") & country ==13) %>%
  dplyr::arrange(country)
...
```{r PHtab, echo=FALSE, echo=F, eval=T, fig.width=1.5, fig.height=3, fig.align='center'}
tab <- plot_ly(
  type = 'table',
  columnwidth = c(1),
  columnorder = c(0),
...
awa <- test %>%
  dplyr::select(b_value, country, labels_countries, labels_quarters,
                quarter_measurement, unaided, toma, aided, main_competition, label) %>%
  dplyr::filter(quarter_measurement > 18 & country==14) %>%
  distinct() %>%
  dplyr::group_by(quarter_measurement) %>%
  dplyr::mutate(
    market_average_unaided = case_when(
